let mot, mots_5, mots_6, mots_7, mots_8, mots_9, mots_10, choix, nbaleatoire, entréeUser, lettreTrouvée, lettreNonTrouvée, essai;
...
function motAleatoire (){
    ...
    switch(choix){
        case '5':
            ...
            break;
        case '6':
            nbaleatoire = parseInt(Math.random() * (mots_6.length - 0) + 0);
            mot = mots_6[nbaleatoire];
            mot = mot.toUpperCase();;
            break;
        case '7':
            nbaleatoire = parseInt(Math.random() * (mots_7.length - 0) + 0);
            mot = mots_7[nbaleatoire];
            mot = mot.toUpperCase();;
            break; 
        case '8':
            nbaleatoire = parseInt(Math.random() * (mots_8.length - 0) + 0);
            mot = mots_8[nbaleatoire];
            mot = mot.toUpperCase();;
            break;
        case '9':
            nbaleatoire = parseInt(Math.random() * (mots_9.length - 0) + 0);
            mot = mots_9[nbaleatoire];
            mot = mot.toUpperCase();;
            break;
        case '10':
            nbaleatoire = parseInt(Math.random() * (mots_10.length - 0) + 0);
            mot = mots_10[nbaleatoire];
            mot = mot.toUpperCase();;
            break;
        default:
